...
/**
 * Sorts flag entries alphabetically by name.
 * @param {Array<[string, Object]>} flagEntries - Array of [name, flag] pairs
 * @returns {Array<[string, Object]>}
 */
export function sortFlags(flagEntries) {
  return [...flagEntries].sort(([a], [b]) => a.localeCompare(b));
}
