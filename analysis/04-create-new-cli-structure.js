...
function generateCommandFile(command) {
  ...
  const argsArray = [
    ...inlineArgs,
    ...mainCommandImportedArgs.map((argKey) => getArgOptionExportName(argKey, 'arg')),
    ...globalImportedArgs.map((argKey) => getArgOptionExportName(argKey, 'arg')),
  ];
