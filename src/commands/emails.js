 ...
 */
export async function addSecondary(_flags, secondaryAddress) {
 ...
 * @param {Array<string>} params.args
 */
export async function setPrimary(_flags, newPrimaryAddress) {
  const addresses = await getUserEmailAddresses();
 ...
 * @param {Array<string>} params.args
 */
export async function removeSecondary(_flags, addressToRemove) {
  const addresses = await getUserEmailAddresses();
 ...
 */
export async function removeAllSecondary(flags) {
  if (!flags.yes) {
