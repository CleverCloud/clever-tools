...
export async function create(flags, providerName, name) {
  const {
    link: linkedAppAlias,
    plan: planName,
    region,
...
export async function deleteAddon(flags, addon) {
...
export async function rename(flags, addon, newName) {
...
export async function listProviders(flags) {
  const { format } = flags;
...
export async function showProvider(flags, providerName) {
  const { format } = flags;
...
export async function env(flags, addonIdOrRealId) {
