    ...
    default: {
      if (keys.length === 0) {
        Logger.println(dedent`
          ${colors.blue('🔐 Current user has no SSH keys')}
          
          To list the SSH keys on your local system, you can use the following command:
      ...
      Logger.println(`🔐 Current user has ${keys.length} SSH key(s):`);
      keys.forEach((key) => {
