 ...
 */
export async function createNg(flags, ngLabel) {
 ...
 * @param {Object} params.options.org Organisation ID or name
 */
export async function deleteNg(flags, ngIdOrLabel) {
  const { org } = flags;
 ...
 * @param {Object} params.options.org Organisation ID or name
 */
export async function createExternalPeer(flags, peerIdOrLabel, ngIdOrLabel, publicKey) {
  const { org } = flags;
 ...
 * @param {Object} params.options.org Organisation ID or name
 */
export async function deleteExternalPeer(flags, peerIdOrLabel, ngIdOrLabel) {
  const { org } = flags;
 ...
 * @param {Object} params.options.org Organisation ID or name
 */
export async function linkToNg(flags, resourceId, ngIdOrLabel) {
  const { org } = flags;
 ...
 * @param {Object} params.options.org Organisation ID or name
 */
export async function unlinkFromNg(flags, resourceId, ngIdOrLabel) {
  const { org } = flags;
 ...
 */
export async function getPeerConfig(flags, peerIdOrLabel, ngIdOrLabel) {
 ...
 * @param {string} params.options.format Output format
 */
export async function listNg(flags) {
  const { org, format } = flags;
 ...
 * @param {string} params.options.format Output format
 */
export async function get(flags, idOrLabel) {
  const { org, format } = flags;
 ...
 * @param {string} params.options.format Output format
 */
export async function search(flags, idOrLabel) {
  const { org, format } = flags;
