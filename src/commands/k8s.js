...
export async function create(flags, ...args) {
...
export async function del(flags, clusterIdOrName) {
...
export async function get(flags, clusterIdOrName) {
  const { format, org: orgIdOrName } = flags;
...
export async function addPersistentStorage(flags, clusterIdOrName) {
  const orgIdOrName = flags.org;
...
export async function getConfig(flags, clusterIdOrName) {
  const orgIdOrName = flags.org;
