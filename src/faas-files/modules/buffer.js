...
function dew () {
  ...
  function utf8Slice (buf, start, end) {
    ...
    while (i < end) {
      ...
      if (i + bytesPerSequence <= end) {
        let secondByte = (void 0); let thirdByte = (void 0); let fourthByte = (void 0); let tempCodePoint = (void 0);
  ...
  Buffer.prototype.readBigUInt64BE = defineBigIntMethod(function readBigUInt64BE (offset) {
    ...
    const hi = first * Math.pow(2, 24) + this[++offset] * Math.pow(2, 16) + this[++offset] * Math.pow(2, 8) + this[++offset];
    const lo = this[++offset] * Math.pow(2, 24) + this[++offset] * Math.pow(2, 16) + this[++offset] * Math.pow(2, 8) + last;
  ...
  Buffer.prototype.readBigInt64LE = defineBigIntMethod(function readBigInt64LE (offset) {
    ...
    const val = this[offset + 4] + this[offset + 5] * Math.pow(2, 8) + this[offset + 6] * Math.pow(2, 16) + (last << 24); // Overflow
  ...
  function E (sym, getMessage, Base) {
    errors[sym] = /* @__PURE__ */(function (Base) {
      ...
      const prototypeAccessors = { code: { configurable: true } };
...
const kMaxLength = exports.kMaxLength;
