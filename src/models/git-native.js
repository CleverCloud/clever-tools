...
class GitNotFoundError extends Error {
  constructor() {
    super(
      'The native-git feature requires git to be installed and available in your PATH\n' +
        'Either install git or disable this feature with: clever features disable native-git',
    );
