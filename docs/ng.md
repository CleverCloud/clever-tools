...
To use Network Groups, you need [Clever Tools installed](/docs/setup-systems.md) in a test version or higher than `3.9.0`. You can check your version with the following command:
